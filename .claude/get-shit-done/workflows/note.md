...
- **Global scope**: `/home/coder/project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/coder/project/.claude/notes/`)
...
2. Glob `/home/coder/project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/coder/project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/coder/project/.claude/notes/` — works in any directory
