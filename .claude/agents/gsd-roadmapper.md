...
Reference full template: `/home/coder/project/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/coder/project/.claude/get-shit-done/templates/state.md`.
