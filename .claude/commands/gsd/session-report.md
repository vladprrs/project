...
<execution_context>
@/home/coder/project/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/home/coder/project/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
